...
(function() {
    ...
    function init() {
        document.querySelectorAll('.matrix-rain, .matrix-rain-enhanced, .tech-particles')
    ...
    // GitHub Pages is static, so hide the counter until it has a real analytics source.
    function setupVisitorCounter() {
        document.querySelectorAll('.visitor-counter').forEach(counter => {
            counter.hidden = true;
        });
    }
